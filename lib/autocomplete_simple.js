...
var autocomplete_simple = function(manager,
	...
	source: function(request_data, response_hook){
	    manager.jq_vars['success'] = function(json_data){
		var retlist = [];
		var resp = new bbop_response_golr(json_data);
	    ...
	    manager.JQ.ajax(manager.get_query_url(), manager.jq_vars);
	},
	...
	select: function(event, ui){
	    ...
	    if( doc_to_apply && 
		bbop.core.is_defined(manager._list_select_callback) ){
		manager._list_select_callback(doc_to_apply);
	    }
	},
