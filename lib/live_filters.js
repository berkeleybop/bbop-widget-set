...
var live_filters = function(interface_id, manager, golr_conf_obj,
	...
	this.setup_query = function(){
	    ...
	    var clear_query_obj =
		    //widget.display.clickable_object(icon_clear_label);
		    widget.display.clickable_object(null);
	    ...
	    var clear_div =
		    new html.tag('div', clear_div_attrs, clear_query_obj);	
	...
	this.draw_accordion = function(response, manager){	    
	    ...
	    //
    		...
    		jQuery('#' + button_id).click(
    			...
    			// placeholder.
    			var fs = widget.display.filter_shield;
...
module.exports.live_filters = live_filters;
